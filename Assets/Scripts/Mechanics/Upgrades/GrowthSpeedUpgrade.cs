...
[System.Serializable]
[CreateAssetMenu(fileName = "New Growth Speed Upgrade", menuName = "Upgrade/Growth Speed")]
public class GrowthSpeedUpgrade : BaseUpgrade
{
    [Tooltip("Upgrades for each level")]
    public List<GrowthSpeedUpgrade_Level> upgrades = new List<GrowthSpeedUpgrade_Level>();
...
[System.Serializable]
public class GrowthSpeedUpgrade_Level : BaseUpgrade_Level
{
    [Range(0, 100)]
